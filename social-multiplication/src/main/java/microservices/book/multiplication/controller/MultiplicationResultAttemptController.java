...
final class MultiplicationResultAttemptController {
    ...
    @PostMapping
    ResponseEntity<MultiplicationAttempt> postResult(
            final @RequestBody MultiplicationAttempt
    ...
    @GetMapping
    ResponseEntity<List<MultiplicationAttempt>> getStatistics(
    ...
    @GetMapping("/{resultId}")
    ResponseEntity<MultiplicationAttempt> getResultById(final @PathVariable("resultId") Long resultId) {
